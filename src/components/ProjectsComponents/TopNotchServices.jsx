...
// export default function TopNotchServices({ data }) {
//   const {
//     title,
//     body,
//     features,
...
//         {/* Left: content */}
//         <div>
//           <h2 className="text-3xl font-extrabold leading-tight text-white sm:text-4xl md:text-[40px]">
//             {title}
//           </h2>
//           <p className="mt-3 max-w-2xl text-[13.5px] leading-6 text-white/80 sm:text-[14.5px] sm:leading-7">
//             {body}
//           </p>
...
//                 <span className="mt-0.5 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-orange-500/15 ring-1 ring-orange-500/30">
...
//           <div className="overflow-hidden rounded-2xl bg-[#5b2aa8] p-4 shadow-[0_12px_30px_rgba(0,0,0,0.35)] ring-1 ring-white/10">
//             <div className="rounded-xl bg-[#1a1b1f] p-2">
//               <img
//                 src={image}
...
export default function TopNotchServices({ data = topNotchAutomationServices }) {
